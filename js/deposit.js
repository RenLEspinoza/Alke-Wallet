$(document).ready(function () {
  ...
  $("#btn-depositar").click(function () {
    ...
    let ingresosActuales =
      parseFloat(localStorage.getItem(llaveIngresos)) || 250000;
    ...
    mostrarAlerta(
      `¡Depósito exitoso de $${monto.toLocaleString("es-CL")} realizado con éxito!`,
      "alert-success",
    );
    $("#montoDeposito").val("");
  });
  ...
  $("#btn-retirar").click(function () {
    ...
    mostrarAlerta(
      `¡Retiro exitoso de $${monto.toLocaleString("es-CL")} completado con éxito!`,
      "alert-success",
    );
    $("#montoDeposito").val("");
  });
